...
document.addEventListener('DOMContentLoaded', function () {
  var onEventCallback = function onEventCallback(evt) {
    var el = evt.target;
...
var moreButton = document.querySelector('[data-more-button]');
var additional = document.querySelectorAll('[data-additional-text]');
...
var accordionBlock = document.querySelectorAll('[data-accordion-block]');
var accordionTitle = document.querySelectorAll('[data-accordion-title]');
var accordionText = document.querySelectorAll('[data-accordion-text]');
if (accordionTitle && accordionText) {
  ...
  accordionText.forEach(function (element) {
    if (element.classList.contains('no-js')) {
      element.classList.remove('no-js');
    }
  });
  accordionBlock.forEach(function (element) {
    element.addEventListener('click', function () {
      var temp = element.firstElementChild;
      var setClasses = !temp.classList.contains('is-active');
...
var orderButton = document.querySelector('[data-order-button]');
...
var modalUserName = document.querySelector('[data-input-username]');
var modalUserPhone = document.querySelector('[data-input-phone]');
var modalTextarea = document.querySelector('[data-textarea-question]');
...
var focusableEls = modal.querySelectorAll('a[href]:not([disabled]), button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="tel"]:not([disabled]), input[type="text"]:not([disabled]), input[type="checkbox"]:not([disabled]), select:not([disabled])');
...
function onClickOverlay(evt) {
  var elementsСlickArea = !evt.composedPath().includes(modalWrapper);
